...
public class WebRTCClient {
    ...
    public void call(String target){
        try{
            peerConnection.createOffer(new com.example.project_ez_talk.webTRC.MySdpObserver(){
                @Override
                public void onCreateSuccess(SessionDescription sessionDescription) {
                    super.onCreateSuccess(sessionDescription);
                    peerConnection.setLocalDescription(new com.example.project_ez_talk.webTRC.MySdpObserver(){
                        @Override
    ...
    public void answer(String target){
        try{
            peerConnection.createAnswer(new com.example.project_ez_talk.webTRC.MySdpObserver(){
                @Override
                public void onCreateSuccess(SessionDescription sessionDescription) {
                    super.onCreateSuccess(sessionDescription);
                    peerConnection.setLocalDescription(new com.example.project_ez_talk.webTRC.MySdpObserver(){
    ...
    public void onRemoteSessionReceived(SessionDescription sessionDescription){
        peerConnection.setRemoteDescription(new com.example.project_ez_talk.webTRC.MySdpObserver(),sessionDescription);
    }
